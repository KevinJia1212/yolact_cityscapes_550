...
CITYSCAPES_CLASS = ('car', 'pedestrian', 'truck', 'bus', 'rider')
...
########################    APLLO    #####################
apllo_dataset = dataset_base.copy({
    'name': 'Apllo_instance Dataset',
    'train_images': '/home/d205-kun/cityscapes/train/training_images',
    'train_info': '/home/d205-kun/cityscapes/train/train.json',
    'valid_images': '/home/kun/apllo_04/images',
    'valid_info': '/home/kun/apllo_04/road04_cam5ins.json',
    'class_names': CITYSCAPES_CLASS,
    'label_map': CITYSCAPES_LABEL_MAP
})
########################    APLLO    #####################
...
yolact_base_cityscapes_config = cityscapes_base_config.copy({
    'name': 'yolact_base_cityscapes',

    # Dataset stuff
    'dataset': cityscapes_dataset,
    # 'dataset': apllo_dataset,
...
# Default config
cfg = yolact_base_cityscapes_config.copy()
